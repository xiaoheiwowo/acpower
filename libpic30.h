...
extern void _memcpy_eds_3(__eds__ void *src, __eds__ void *dst, int len);
...
#define _memcpy_eds(dst, src, len) _memcpy_eds_3(src, dst, len)
...
#define _FLASH_ROW     32
#endif
#define _FLASH_2ROWS   (2*_FLASH_ROW)
#define _FLASH_4ROWS   (4*_FLASH_ROw)
